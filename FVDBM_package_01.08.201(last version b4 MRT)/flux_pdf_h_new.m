function [fl,f_c_old]=flux_pdf_h_new(CELL,M,NODE,N,FACE,O,f_nd,f_old,f_c_old,feq,RHO,Rho_r,V,dt,wl,wlb,wh,V1,V2,interior,periodic,inlet,outlet,s_wall,m_wall,well_dp,iof,fupd,ftvd,fpdc,fd,fm,fmp,fe)
...
%                     fs_uu=inter_extrp(0,dis(Coor_intcp,s_stcl_coord_234(:,3)),dis(Coor_intcp,s_stcl_coord_234(:,2)),fs_intcpt,fs_u,fs_d,-dis(Coor_intcp,s_stcl_coord_234(:,4)),fe);
        ...
        if face_type==1 || face_type==4
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_14,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),interior,fupd,ftvd);
        elseif face_type==3
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),interior,fupd,ftvd);
        else
            error('Logic error!');
        end
    elseif face_bc_flag>0 % Outer boundary face
        if face_bc_flag==1 % Periodic
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),periodic,fupd,ftvd);
...
%                     fs_uu=fs_intcpt; % A even better scheme
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),inlet,fupd,ftvd);
...
%                     fs_uu=fs_intcpt; % A even better scheme
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),outlet,fupd,ftvd);
...
%                     fs_uu=fs_intcpt; % A even better scheme
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),s_wall,fupd,ftvd);
...
%                     fs_uu=fs_intcpt; % A even better scheme
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),m_wall,fupd,ftvd);
        elseif face_bc_flag==6
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),well_dp,fupd,ftvd);
...
%                     fs_c=(fs_d*s_dis(1,1)-fs_dd*s_dis(1,2))/(s_dis(1,1)-s_dis(1,2)); % Explode
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_23,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),iof,fupd,ftvd);
        else
...
%                     fs_uu=fs_intcpt; % A even better scheme
            ...
            %% calculate the PDFs at the face center
            f_face=pdf_face_new(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,ls_14,latt_dir_marker,dt,face_normal_lattice,f_c_old(:,r),s_wall,fupd,ftvd);
        else
            error('Wrong flag for face on outer boundaries!');
        end
    else
