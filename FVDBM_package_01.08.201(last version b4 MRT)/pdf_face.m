function [f_f, f_c_current_time_step]= pdf_face(fs_dd,fs_d,fs_u,fs_uu,fs_dd_ctd,fs_d_ctd,fs_u_ctd,fs_uu_ctd,f_c_previous_time_step,s,marker,dt,f_normal_latt_dot,FX,FUPD,FTVD)
