function g_bc=pdf_bc_t(N_L,N_H,N_I,tau_g,dt,NODE,ND,f,feq,f_node,g,geq,g_node,U_node,U,RHO_node,RHO,V,V1,V2,Rho_r,Rho_in,Rho_out,qh,qt,wc,wh,wt,fd,fdcy,NPdc,NInt,NOut,NStw,NMow,NWdp,NIof,NC70,NC71,NC72,NC73,NC74,NC75,NC76,NC77,NC78,NC79,NC80)
