...
%   Type 3: the cell that has one and only one face attached to the inner boundary.
    ...
    for i=1:M
        ...
        if CL{37}==1 % cell type 1
            ...
            cell2=CL{3};
            cell3=CL{4};
            %% Old scheme, find the third point using the boundary nodes
            if cell1==0
                FC_bc=FACE{CL{16}};
                Cell2=CELL{cell2};
                Cell3=CELL{cell3};
%                 dis_vec_1=CL{28}-CL{5}; % Third point is the mid-point of the boundary face
                ghost_centroid=mirror(CL{5},FC_bc{5},FC_bc{6}); % Third point is the centroid of ghost cell
                dis_vec_1=ghost_centroid-CL{5}; % Third point is the the centroid of ghost cell
                dis_vec_2=Cell2{5}-CL{5};
                dis_vec_3=Cell3{5}-CL{5};
            elseif cell2==0
                FC_bc=FACE{CL{17}};
                ...
                Cell3=CELL{cell3};
                dis_vec_1=Cell1{5}-CL{5};
%                 dis_vec_2=CL{29}-CL{5}; % Third point is the mid-point of the boundary face
                ghost_centroid=mirror(CL{5},FC_bc{5},FC_bc{6}); % Third point is the centroid of ghost cell
                dis_vec_2=ghost_centroid-CL{5}; % Third point is the centroid of ghost cell
                dis_vec_3=Cell3{5}-CL{5};
            elseif cell3==0
                FC_bc=FACE{CL{18}};
                Cell1=CELL{cell1};
                ...
                dis_vec_1=Cell1{5}-CL{5};
                dis_vec_2=Cell2{5}-CL{5};
%                 dis_vec_3=CL{30}-CL{5}; % Third point is the mid-point of the boundary face
                ghost_centroid=mirror(CL{5},FC_bc{5},FC_bc{6}); % Third point is the centroid of ghost cell
                dis_vec_3=ghost_centroid-CL{5}; % Third point is the centroid of ghost cell
            else
                error('Logic error!');
            end
...
%                 Cell2=CELL{cell2};
%                 Cell3=CELL{cell3};
%                 dis_vec_1=Cell2{5}-CL{5};
%                 dis_vec_2=Cell3{5}-CL{5};
%             elseif cell2==0
%                 FC_bc=FACE{CL{17}};
%                 Cell1=CELL{cell1};
%                 Cell3=CELL{cell3};
...
% 
% 
%             dis_sq=[dis_vec_1'*dis_vec_1,dis_vec_2'*dis_vec_2];
%             w=1./dis_sq;
%             
%             A=zeros(2,2);
%             dis_vec=[dis_vec_1,dis_vec_2];
%             for j=1:2
%                 A=A+w(j)*(dis_vec(:,j)*dis_vec(:,j)');
%             end
%             
...
% %         end
% %     end
%     %% Algorithm 3 Xiaofrng's 2nd-order mapping scheme
