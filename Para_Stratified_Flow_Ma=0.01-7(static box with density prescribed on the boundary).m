...
U_in=[0,0.01,0.01,0.01/sqrt(3);2,0,0,0]; % Inlet velocity [top,right,bottom,left]
...
FMP=7; % Flag for mapping, FMP=1---First-order; FMP=2---Second-order
...
NOut=3099; % 3100 for extrapolated u and v; 3199 for extrapolated u, v=0; 3099 for both density and velocity prescribed
NStw=499;
NMow=515;
NWdp=620;
NIof=800;
