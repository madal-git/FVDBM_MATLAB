...
FTH=1; %%%% Flag for thermal model. 0---Isothermal; 1---Thermal
...
dt2=0.4*Tau_t;
dt=min(dt1,dt2);
Time_stop=1; %% seconds, this value is used to compared with FD solution
Timer=Time_stop/dt
...
Rho_in=[2,2,2,2.000138564]; % Inlet density [top,right,bottom,left]
F_rho_in=[0,0,0,0]; % Variable distribution type for inlet density [top,right,bottom,left]; 0 --- constant; 1 --- Linear; 2 --- Parabolic

Rho_out=[2,1.999861436,2,2]; % Outlet density [top,right,bottom,left]
...
% Thermal
T_bc=[2/3,1/3,1/3,2/3,2/3];  % Temperature [top,right,bottom,left,immersed]
...
NPdc=131;
NInt=2100; % 2010 for U inlet; 2100 for Rho inlet; 2099 for U and Rho Inlet
