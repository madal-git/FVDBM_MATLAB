...
for l=2734:2734
    ...
    if FC{2}>=0 % Exclude the inner boundary
        fc16=FC{16};
        fc23=FC{23};
        if length(union(0,fc16))<=length(fc16) && (fc23(1,1)>=0 || fc23(1,end)>=0)% Face type 2 and 3, which has at least one of the stencil point is out of boundary
            C_b=FC{7};
            fc18=FC{18};
            fc25=FC{25};
            fc26=FC{26};
            ...
            plot(fc26(1,1),fc26(2,1),'Marker', 'o','Markersize',3, 'MarkerFaceColor', 'c','MarkerEdgeColor', 'c');
            pause(T)
            hold on;
            %% Plot the further downwind stencil point
            c_d=CELL{fc25(1,2)};
            ...
            plot(fc26(1,2),fc26(2,2),'Marker', 'o','Markersize',3, 'MarkerFaceColor', 'g','MarkerEdgeColor', 'g');
            pause(T)
            hold on;
            ...
            plot(fc26(1,3),fc26(2,3),'Marker', 'o','Markersize',3, 'MarkerFaceColor', 'm','MarkerEdgeColor', 'm');
            pause(T)
            hold on;
            ...
            plot(fc26(1,4),fc26(2,4),'Marker', 'o','Markersize',3, 'MarkerFaceColor', 'r','MarkerEdgeColor', 'r');
            pause(T)
            hold on;
