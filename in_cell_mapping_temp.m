function [x,a]=in_cell_mapping(FC,CELL,NODE,x_c,x_nd,s_cell,s_stcl_coord,s_map_id,s_map_coord,gradient,FMP,V,FPDC)
...
%         x=x_c(:,s_cell)+((s_stcl_coord-cell_center{5})'/sqrt(cell_center{6})*(CoeA*F))';
        ...
        a=s_stcl_coord-cell_center{5};
        if abs(a(1))<1e-9 || abs(a(2))<1e-9
            a
        end
