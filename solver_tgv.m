...
tic;
while max(abs(U_sim_hori(2,:)/U_0))>0.5
        ...
        elseif FT==4 % RK2
            ...
            for l=1:N
                ...
                if NP{2}==0 % Interior nodes
                    ...
                    f_nd_K1(:,l)=pdf_bc_h(N_L,N_H,N_I,Tau,dt,NODE,NP,CELL,f_old,f_eq,f_nd,U_nd,U,Rho_nd,Rho,V,V1,V2,Rho_ref,Rho_in,Rho_out,qh,wc,wh,FD,FDC,NPdc,NInt,NOut,NStw,NMow,NWdp,NIof,NC70,NC71,NC72,NC73,NC74,NC75,NC76,NC77,NC78,NC79,NC80);
                end
            end
            %%%%%% Update macro velocity and density at nodes
...
%                 end
                ...
                for l=1:N
                    ...
                    if NP{2}==0 % Interior nodes
                        ...
                        g_nd(:,l)=pdf_bc_t(N_L,N_H,N_I,Tau_t,dt,CELL,NP,f_old,f_eq,f_nd,g_old,g_eq,g_nd,U_nd,U,Rho_nd,Rho,V2,V1,V2,Rho_ref,Rho_in,Rho_out,qh,qt,wc,wh,wt,FD,FDC,NPdc,NInt,NOut,NStw,NMow,NWdp,NIof,NC70,NC71,NC72,NC73,NC74,NC75,NC76,NC77,NC78,NC79,NC80);
                    end
                end
                %%%%% Nodal variable update
                %%%% Calculate flux integral for all triangles
